...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $sql = "UPDATE student_insertion 
            SET Studentame = '$name', CourseName = '$course', Semester = '$semester', Gender = '$gender', Hobbies = '$hobbies' 
            WHERE StudentId = '$id'";
...
<body>
    ...
    <form method="POST" action="">
        ...
        <input type="text" name="name" value="<?php echo $student['Studentame']; ?>" required><br><br>
